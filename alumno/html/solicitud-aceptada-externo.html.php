...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="solicitud-aceptada-externo.css">
    ...
    <div class="container-fluid p-0">
        <div class="row">
            ...
            <div class="col-auto p-0 h-100">
                <img src="gestec-cta.png" class="img-fluid h-100">
            </div>
                ...
                <div class="row">
                    <div class="col h-auto">
                        <div class="row">
                            ...
                            <p class="lead text-center">Preséntate en GESTEC en el aula <strong>L-105 </strong> con tu <strong>folio y credencial de estudiante.</strong> </p>
                        </div>
